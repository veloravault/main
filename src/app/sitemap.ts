...
const LAST_MODIFIED = {
  ...
  sshKeys: "2026-07-23",
  cryptoPassphrases: "2026-07-23",
  apiCredentials: "2026-07-23",
  wifiPasswords: "2026-07-23",
  twoFactorBackupCodes: "2026-07-23",
  help: "2026-07-23",
  faq: "2026-07-23",
...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/features/ssh-keys`, lastModified: LAST_MODIFIED.sshKeys, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/features/crypto-passphrases`, lastModified: LAST_MODIFIED.cryptoPassphrases, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/features/api-credentials`, lastModified: LAST_MODIFIED.apiCredentials, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/features/wifi-passwords`, lastModified: LAST_MODIFIED.wifiPasswords, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/features/2fa-backup-codes`, lastModified: LAST_MODIFIED.twoFactorBackupCodes, changeFrequency: "monthly", priority: 0.7 },
